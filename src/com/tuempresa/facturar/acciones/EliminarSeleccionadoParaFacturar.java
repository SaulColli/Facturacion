...
extends TabBaseAction // Para trabajar con datos tabulares (lista) por medio de getTab() así no hay necesidad de una nueva entidad
...
public void execute() throws Exception {
    ...
    if (!getMetaModel().containsMetaProperty("eliminado")) {             //Sin meta modelo que deporsí ya se almacena no se encuentra entonces
...
private void marcarEntidadesSeleccionadasComoEliminadas() throws Exception {
    ...
    if (clavesSeleccionadas != null) {     // Sí las claves seleccionadas no son nulas entonces
